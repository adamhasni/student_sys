    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <form class="form-horizontal" method="POST" action="{{ route ('level.update', $level->id)}}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <select id="level_number" name="level_number" class="form-control">
                              <option value="1"{{($level->level_number == 1) ? "selected":null}}>1</option>
                              <option value="2"{{($level->level_number == 2) ? "selected":null}}>2</option>
                              <option value="3"{{($level->level_number == 3) ? "selected":null}}>3</option>
                            </select>
                          </div>
                        </div>
